...
A detailed setup, architecture, SharePoint schema, execution, validation, CI/CD, UI, and troubleshooting guide is available at [docs/wiki/Home.md](docs/wiki/Home.md). Publish this file as the repository Wiki **Home** page if GitHub Wiki is enabled.
